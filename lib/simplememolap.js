...
var simplememolap = (function () {
    ...
    function SortCursor(dataset, cursor, fields, options) {
        ...
        function sort() {
            var tuples = toTupleArray(cursor, ndimensions);
            
            tuples.sort(comparer);
            
            newtuples = new Dataset({ dimensions: dimensions, tuples: tuples }).tuples();
        }
    ...
    function DatasetCursor(dataset) {
        ...
        this.sort = function (fields) { return new SortCursor(dataset, this, fields); }
